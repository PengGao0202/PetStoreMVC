...
namespace PetStoreMVC.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public OwnersController(PetStoreMVCContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,Street,City,EmailAddress,PhoneNumber,Occupation")] Owner owner)
        {
            if (id != owner.ID)
            {
                return NotFound();
